...
/**
 Determine whether the device has torch
 */
@property (nonatomic, readonly) BOOL deviceHasTorch;
...
/**
 reset the sample buffer with beauty face.
 */
- (void)setVideoSampleBuffer:(CVPixelBufferRef _Nonnull)sampleBuffer;

/**
 reconfig video intput & audiu input.
 */
