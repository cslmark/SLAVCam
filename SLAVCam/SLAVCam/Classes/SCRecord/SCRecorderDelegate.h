...
- (void)captureOutput:(AVCaptureOutput *_Nullable)captureOutput previewBuffer:(CMSampleBufferRef _Nullable )sampleBuffer fromConnection:(AVCaptureConnection *_Nullable)connection;
